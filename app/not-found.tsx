    ...
    <main className="mx-auto flex min-h-[70vh] max-w-3xl items-center px-4 py-16 sm:px-6">
      <section className="glass-panel w-full rounded-2xl p-6 sm:p-8">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <Link href="/history" className="inline-flex min-h-11 items-center rounded-xl border border-white/12 px-5 text-sm font-semibold text-slate-100 transition hover:bg-white/[0.05]">
            Trip history
          </Link>
        </div>
      </section>
