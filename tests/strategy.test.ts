...
function createAnalysis(): RouteAnalysisResponse {
  ...
  return {
    ...
    hazardWindows: [
      {
        ...
        startSampleIndex: 1,
        endSampleIndex: 1,
        approximateLocationLabel: "near route km 45",
        summary: "Severe winter risk near route km 45.",
      },
    ],
    summary: {
      overallScore: 70,
    ...
    tripDecision: {
      decision: "HOLD",
      decisionLabel: "Hold before the dangerous stretch",
      decisionSummary: "Test decision.",
      confidence: "High",
      confidenceReasons: [],
      overallRisk: "High",
      worstSegmentRisk: "Severe",
      worstSegmentLocationLabel: "near route km 45",
      worstSegmentArrivalTime: samples[1].etaDisplay,
      mainHazards: ["Heavy snow"],
      dangerWindows: [],
      holdRecommendation: null,
      saferDepartureWindows: [],
      explanationBullets: [],
      dataQualityNotes: [],
      safetyDisclaimer: "Test disclaimer.",
    },
  };
}
