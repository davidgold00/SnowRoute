        ...
        <header className="glass-panel rounded-[36px] px-6 py-6 lg:px-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="space-y-4">
              <div className="rounded-full border border-cyan-300/20 bg-cyan-400/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.28em] text-cyan-100 w-fit">
                Analyze a trip
              </div>
              <div className="space-y-3">
                <p className="eyebrow">Winter route operations desk</p>
                <h1 className="display-type max-w-4xl text-4xl leading-[0.95] text-white sm:text-5xl">
                  Plan one trip at a time, with the full route scored against the forecast.
                </h1>
                <p className="max-w-3xl text-sm leading-7 text-slate-300 sm:text-base">
                  Lock the route, match weather to ETA, and inspect every checkpoint in one
                  workspace designed for winter travel decisions.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-300">
                    The live dashboard below is synchronized around the current route analysis,
